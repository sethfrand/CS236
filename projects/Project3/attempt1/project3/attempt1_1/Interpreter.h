...
{
    public:
    Interpreter(const DatalogProgram& datalogProgram, Database& database) : datalogprogram (datalogProgram), database(database) {}
    ...
    void Project(const &Relation relation, const vector <int>& columns)
    {
        Scheme newScheme;
        ...
        Relation result (realtion.getName(), newScheme)
        {
